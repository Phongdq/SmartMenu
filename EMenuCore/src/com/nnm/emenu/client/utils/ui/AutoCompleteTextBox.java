...
//		choicesPopup.addStyleName("AutoCompleteChoices");
		choicesPopup.setStyleName("popup");

//		choices.setStyleName("list");
		choices.setStyleName("listbox");
		getElement().setAttribute("placeholder", "đồ ăn / đồ uống");
	}
	...
	public void onKeyUp(Widget arg0, char arg1, int arg2) {
		...
		if (matches.size() > 0) {
			...
			if (matches.size() == 1 && matches.get(0).compareTo(text) == 0) {
				choicesPopup.hide();
			} else {
